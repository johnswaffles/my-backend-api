    ...
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.96),_rgba(250,246,236,0.82)_34%,_rgba(236,244,227,0.96)_66%,_rgba(247,241,228,1)_100%)] text-stone-900">
      ...
      <main className="relative mx-auto flex min-h-screen w-full max-w-5xl flex-col gap-5 px-4 py-4 sm:px-5 sm:py-5 lg:px-6">
        ...
        <section className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="rounded-[2rem] border border-white/70 bg-white/72 p-4 shadow-[0_18px_55px_rgba(61,79,42,0.12)] backdrop-blur-2xl sm:p-5">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-7 text-stone-600 sm:text-base">
              Enter a town or ZIP, add a food type if you want tighter results, and the widget will return the best verified places
              with a clean, embeddable layout.
            </p>
          ...
          <aside className="rounded-[2rem] border border-white/70 bg-white/72 p-4 shadow-[0_18px_55px_rgba(61,79,42,0.12)] backdrop-blur-2xl sm:p-5">
            <div className="text-[11px] font-semibold uppercase tracking-[0.24em] text-stone-500">Widget preview</div>
            <div className="mt-3 rounded-[1.6rem] border border-stone-200 bg-white/90 p-4">
              <div className="text-sm font-semibold text-stone-900">How it works</div>
              <ul className="mt-3 space-y-2 text-sm leading-6 text-stone-600">
                <li>1. Enter a town or ZIP.</li>
                <li>2. Add a food type like pizza, burgers, steak, or coffee.</li>
                <li>3. Get a ranked list with map and website links.</li>
              </ul>
            </div>

            <div className="mt-4 rounded-[1.6rem] border border-stone-200 bg-white/90 p-4">
              <div className="text-sm font-semibold text-stone-900">Try one of these</div>
              <div className="mt-3 flex flex-wrap gap-2">
                {TOWN_OPTIONS.slice(0, 8).map((town) => (
                  <button
                    key={town}
                    type="button"
                    onClick={() => void handleQuickTown(town)}
                    className="rounded-full border border-stone-200 bg-white px-3 py-1.5 text-xs font-semibold text-stone-700 transition hover:border-emerald-300 hover:text-emerald-900"
                  >
                    {town}
                  </button>
                ))}
        ...
        <section className="rounded-[2rem] border border-white/70 bg-white/72 p-4 shadow-[0_18px_55px_rgba(61,79,42,0.12)] backdrop-blur-2xl sm:p-5">
